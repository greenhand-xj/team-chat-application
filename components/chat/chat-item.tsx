...
export const ChatItem = ({ id, content, member, timestamp, fileUrl, deleted, currentMember, isUpdated, socketUrl, socketQuery }: ChatItemProps) => {
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 5 p-4 transition w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt-2 rounded-md">
              ...
              <a className="ml-2 text-sm text-indigo-500 dark:text-indigo-400 hove  r:underline" href={fileUrl} target="_blank" rel="noreferrer noopener">
                PDF File
              </a>
            </div>
          )}
                      ...
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            ...
                            className="p-2 bg-zinc-200/20 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
                            autoFocus
                          />
                        </div>
                      </FormControl>
      ...
      {
        canDeleteMessage && (
          <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white border rounded-md dark:bg-zinc-800">
            {canEditMessage && (
